...
const Header = () => {
  ...
  return (
    <header className="flex  w-full fixed z-50  px-1 b">
      ...
      <div className=" b flex flex-grow h-14 items-center justify-between px-8 blurred-bg bg-[var(--secondary-bg)] text-[var(--secondary-fg)] rounded-lg">
        {/* Logo and Navigation */}
        <div className="b flex items-center w-full gap-20 text-nowrap mr-4">
